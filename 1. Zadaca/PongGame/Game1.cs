...
namespace PongGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
           ...
           if (touchState.IsKeyDown(Keys.Left))
            ...
            PaddleTop.Position.X = MathHelper.Clamp(PaddleTop.Position.X,
               bounds.Left, bounds.Right - PaddleTop.Size.Width);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < SpriteForDrawList.Count; i++)
            {
                SpriteForDrawList.GetElement(i).Draw(spriteBatch);
            }
        ...
        /// </summary>
        private IGenericList<Sprite> SpriteForDrawList = new GenericsList<Sprite>();
    }
    ...
    public class CollisionDetector
    {
        ...
        {
            return ((s1.Position.X + s1.Size.Width >= s2.Position.X) && (s1.Position.Y + s1.Size.Height > s2.Position.Y)) &&
                   ((s2.Position.X + s2.Size.Width >= s1.Position.X) && (s2.Position.Y + s2.Size.Height > s1.Position.Y));
        }
    }
}